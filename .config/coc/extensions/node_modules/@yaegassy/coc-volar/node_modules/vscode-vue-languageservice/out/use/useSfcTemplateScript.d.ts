...
export declare function useSfcTemplateScript(getUnreactiveDoc: () => TextDocument, template: Ref<IDescriptor['template']>, styles: Ref<IDescriptor['styles']>, templateScriptData: ITemplateScriptData, styleDocuments: Ref<{
...
} | undefined>, sfcTemplateCompileResult: ReturnType<(typeof import('./useSfcTemplateCompileResult'))['useSfcTemplateCompileResult']>, sfcStyles: ReturnType<(typeof import('./useSfcStyles'))['useSfcStyles']>['textDocuments'], context: LanguageServiceContext): {
