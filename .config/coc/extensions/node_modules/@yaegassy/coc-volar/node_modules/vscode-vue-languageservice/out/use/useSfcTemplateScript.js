...
function useSfcTemplateScript(getUnreactiveDoc, template, styles, templateScriptData, styleDocuments, styleSourceMaps, templateData, sfcTemplateCompileResult, sfcStyles, context) {
    let version = 0;
    ...
    function update() {
        var _a;
        if (data.value.getText() !== ((_a = textDoc.value) === null || _a === void 0 ? void 0 : _a.getText())) {
            if (data.value) {
                const _version = version++;
                textDoc.value = vscode_languageserver_textdocument_1.TextDocument.create(vueUri + '.__VLS_template.ts', shared.syntaxToLanguageId('ts'), _version, data.value.getText());
                formatTextDoc.value = templateCodeGens.value
                    ? vscode_languageserver_textdocument_1.TextDocument.create(vueUri + '.__VLS_template.format.ts', shared.syntaxToLanguageId('ts'), _version, templateCodeGens.value.formatCodeGen.getText())
                    : undefined;
