  ...
  "node_modules/vscode-jsonrpc/lib/common/cancellation.js"(exports) {
    ...
    (function(CancellationToken4) {
      ...
      function is(value) {
        ...
        return candidate && (candidate === CancellationToken4.None || candidate === CancellationToken4.Cancelled || Is2.boolean(candidate.isCancellationRequested) && !!candidate.onCancellationRequested);
      }
      CancellationToken4.is = is;
    })(CancellationToken3 = exports.CancellationToken || (exports.CancellationToken = {}));
...
function getConfigDevServerPath() {
  return import_coc10.workspace.getConfiguration("volar").get("dev.serverPath", "");
}
function getConfigMiddlewareProvideCodeActionsEnable() {
  return import_coc10.workspace.getConfiguration("volar").get("middleware.provideCodeActions.enable", true);
}
...
async function activate2(context) {
  ...
  return activate(context, (id, name, documentSelector, initOptions, port, outputChannel) => {
    ...
    const devVolarServerPath = import_coc12.workspace.expand(getConfigDevServerPath());
    if (devVolarServerPath && fs4.existsSync(devVolarServerPath)) {
    ...
    const clientOptions = {
      ...
      middleware: {
        provideCodeActions: getConfigMiddlewareProvideCodeActionsEnable() ? id === "vue-semantic-server" ? handleProvideCodeActions : void 0 : void 0,
    ...
    const client = new import_coc12.LanguageClient(id, name, serverOptions, clientOptions);
...
async function handleProvideCodeActions(document, range, context, token, next) {
